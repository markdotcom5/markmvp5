    ...
    try {
        const response = await openai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "You are an AI challenge strategy advisor providing insights for space training challenges."
                },
                {
                    role: "user",
        ...
        this.aiInsights = {
            recommendedStrategy: response.choices[0].message.content.trim(),
            potentialChallenges: ['Technical complexity', 'Team coordination'],
            successPrediction: Math.random() * 100 // Placeholder
        };
